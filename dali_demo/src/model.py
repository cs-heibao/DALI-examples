...
# Apex imports
try:
    # from src.apex.apex.fp16_utils import *
    from apex.fp16_utils import *
    from apex.parallel import DistributedDataParallel as DDP
    # from src.apex.apex.parallel import DistributedDataParallel as DDP
except ImportError:
...
class Loss(nn.Module):
    ...
    def __init__(self, dboxes):
        ...
        # http://jany.st/post/2014-11-05-single-shot-detector-ssd-from-scratch-in-tensorflow.html
